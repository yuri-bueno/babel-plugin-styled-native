...
const BANNER = `\
// ⚡ Auto-generated by babel-plugin-styled-native — do not edit manually.
// Regenerated automatically when styled.config.ts changes.
`;
...
`;
  ...
  const outputPath = path.join(projectRoot, "styled-types.d.ts");
  ...
  try {
    ...
    console.log(`\x1b[36m[styled-plugin] 📝 Tipos gerados: ${outputPath}\x1b[0m`);
  } catch (e) {
    console.warn("[styled-plugin] Falha ao gerar typed:", e);
  }
}
